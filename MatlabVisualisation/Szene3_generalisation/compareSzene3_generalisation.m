...
for idx = 1:3:length(pos1x)
    ...
    plot([offset offset],[0 6],'k-','linewidth',2) 
    plot([1+offset 1+offset],[0 6],'k-','linewidth',2)
    plot([0.24-cos(winkel1)*0.35+offset 0.24+cos(winkel1)*0.35+offset],[1.47-sin(winkel1)*0.35 1.47+sin(winkel1)*0.35],'k-','linewidth',6)
    plot([0.76-cos(winkel2)*0.35+offset 0.76+cos(winkel2)*0.35+offset],[2.5-sin(winkel2)*0.35 2.5+sin(winkel2)*0.35],'k-','linewidth',6)
    plot([0.2-cos(winkel3)*0.5+offset 0.2+cos(winkel3)*0.5+offset],[4-sin(winkel3)*0.5 4+sin(winkel3)*0.5],'k-','linewidth',6)
    plot([0.8-cos(winkel4)*0.5+offset 0.8+cos(winkel4)*0.5+offset],[4-sin(winkel4)*0.5 4+sin(winkel4)*0.5],'k-','linewidth',6)
    plot([0+offset 1+offset],[6 6],'k-','linewidth',6) 
