...
text(0.5,6.2,txt1,'HorizontalAlignment','center')
text(0.5+offsetX,6.2,txt2,'HorizontalAlignment','center')
text(0.5+offsetX*2,6.2,txt3,'HorizontalAlignment','center')
text(0.5+offsetX*3,6.2,txt4,'HorizontalAlignment','center')
plot([0 0.24+cos(winkel1)*0.34],[1.445-sin(winkel1)*0.34 1.445+sin(winkel1)*0.34],'k-','linewidth',5)
plot([0.76-cos(winkel2)*0.35 0.76+cos(winkel2)*0.35],[2.5-sin(winkel2)*0.35 2.5+sin(winkel2)*0.35],'k-','linewidth',5)
plot([0.2-cos(winkel3)*0.5 0.2+cos(winkel3)*0.5],[4-sin(winkel3)*0.5 4+sin(winkel3)*0.5],'k-','linewidth',5)
plot([0.8-cos(winkel4)*0.5 0.8+cos(winkel4)*0.5],[4-sin(winkel4)*0.5 4+sin(winkel4)*0.5],'k-','linewidth',5)
plot([0 1],[6 6],'k-','linewidth',5) 
plot([0 1],[0 0],'k-','linewidth',3) 
plot([0 0],[0 6],'k-','linewidth',3) 
plot([1 1],[0 6],'k-','linewidth',3)
idx=idx1;
...
plot([ offsetX  offsetX],[0 6],'k-','linewidth',3) 
plot([ offsetX+1  offsetX+1],[0 6],'k-','linewidth',3)
plot([ offsetX  offsetX+0.24+cos(winkel1)*0.34],[1.445-sin(winkel1)*0.34 1.445+sin(winkel1)*0.34],'k-','linewidth',5) 
plot([ offsetX  offsetX+1],[0 0],'k-','linewidth',3) 
plot([ offsetX  offsetX],[0 6],'k-','linewidth',3) 
plot([ offsetX+1  offsetX+1],[0 6],'k-','linewidth',3)
plot([offsetX+0.76-cos(winkel2)*0.35 offsetX+0.76+cos(winkel2)*0.35],[2.5-sin(winkel2)*0.35 2.5+sin(winkel2)*0.35],'k-','linewidth',5)
plot([offsetX 1+offsetX],[6 6],'k-','linewidth',5) 
plot([0.2-cos(winkel3)*0.5+offsetX 0.2+cos(winkel3)*0.5+offsetX],[4-sin(winkel3)*0.5 4+sin(winkel3)*0.5],'k-','linewidth',5)
plot([0.8-cos(winkel4)*0.5+offsetX 0.8+cos(winkel4)*0.5+offsetX],[4-sin(winkel4)*0.5 4+sin(winkel4)*0.5],'k-','linewidth',5)
idx=idx2;
...
plot([ offsetX*2  offsetX*2],[0 6],'k-','linewidth',3) 
plot([ offsetX*2+1  offsetX*2+1],[0 6],'k-','linewidth',3)
plot([ offsetX*2  offsetX*2+0.24+cos(winkel1)*0.34],[1.445-sin(winkel1)*0.34 1.445+sin(winkel1)*0.34],'k-','linewidth',5) 
plot([ offsetX*2  offsetX*2+1],[0 0],'k-','linewidth',3) 
plot([ offsetX*2  offsetX*2],[0 6],'k-','linewidth',3) 
plot([ offsetX*2+1  offsetX*2+1],[0 6],'k-','linewidth',3)
plot([offsetX*2+0.76-cos(winkel2)*0.35 offsetX*2+0.76+cos(winkel2)*0.35],[2.5-sin(winkel2)*0.35 2.5+sin(winkel2)*0.35],'k-','linewidth',5)
plot([0.2-cos(winkel3)*0.5+offsetX*2 0.2+cos(winkel3)*0.5+offsetX*2],[4-sin(winkel3)*0.5 4+sin(winkel3)*0.5],'k-','linewidth',5)
plot([0.8-cos(winkel4)*0.5+offsetX*2 0.8+cos(winkel4)*0.5+offsetX*2],[4-sin(winkel4)*0.5 4+sin(winkel4)*0.5],'k-','linewidth',5)
plot([offsetX*2 1+offsetX*2],[6 6],'k-','linewidth',5) 
idx=idx3;
...
plot([offsetX*3  offsetX*3],[0 6],'k-','linewidth',3) 
plot([offsetX*3+1  offsetX*3+1],[0 6],'k-','linewidth',3)
plot([offsetX*3  offsetX*3+0.24+cos(winkel1)*0.34],[1.445-sin(winkel1)*0.34 1.445+sin(winkel1)*0.34],'k-','linewidth',5) 
plot([offsetX*3  offsetX*3+1],[0 0],'k-','linewidth',3) 
plot([offsetX*3  offsetX*3],[0 6],'k-','linewidth',3) 
plot([offsetX*3+1  offsetX*3+1],[0 6],'k-','linewidth',3)
plot([offsetX*3+0.76-cos(winkel2)*0.35 offsetX*3+0.76+cos(winkel2)*0.35],[2.5-sin(winkel2)*0.35 2.5+sin(winkel2)*0.35],'k-','linewidth',5)
plot([offsetX*3 1+offsetX*3],[6 6],'k-','linewidth',5) 
plot([0.2-cos(winkel3)*0.5+offsetX*3 0.2+cos(winkel3)*0.5+offsetX*3],[4-sin(winkel3)*0.5 4+sin(winkel3)*0.5],'k-','linewidth',5)
plot([0.8-cos(winkel4)*0.5+offsetX*3 0.8+cos(winkel4)*0.5+offsetX*3],[4-sin(winkel4)*0.5 4+sin(winkel4)*0.5],'k-','linewidth',5)
idx=idx4;
