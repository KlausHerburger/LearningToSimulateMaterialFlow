...
for idx = 1:2:length(pos1x)
    ...
    plot([0.65-cos(winkel2)*0.5+offset 0.65+cos(winkel2)*0.5+offset],[3-sin(winkel2)*0.5 3+sin(winkel2)*0.5],'k-','linewidth',6)
